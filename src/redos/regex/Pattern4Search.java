...
public final class Pattern4Search implements java.io.Serializable {
    /**
     ...
     */
    public static Pattern4Search compile(String regex) {
        return new Pattern4Search(regex, 0);
    }
     ...
     * @throws PatternSyntaxException   If the expression's syntax is invalid
     */
    public static Pattern4Search compile(String regex, int flags) {
        return new Pattern4Search(regex, flags);
    }
     ...
     * LastNode node.
     */
    public Pattern4Search(String p, int f) {
        pattern = p;
        flags = f;
    ...
    public static class Node extends Object {
         ...
         */
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
    ...
    static class LastNode extends Node {
         ...
         */
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            if (matcher4Search.acceptMode == Matcher4Search.ENDANCHOR && i != matcher4Search.to) {
                return false;
            }
            matcher4Search.last = i;
            matcher4Search.groups[0] = matcher4Search.first;
    ...
    static class Start extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            if (i > matcher4Search.to - minLength) {
                matcher4Search.hitEnd = true;
                return false;
            }
            int guard = matcher4Search.to - minLength;
            for (; i <= guard; i++) {
                if (next.match(matcher4Search, i, seq, true)) {
                    matcher4Search.first = i;
                    matcher4Search.groups[0] = matcher4Search.first;
                    matcher4Search.groups[1] = matcher4Search.last;
                    return true;
                }
    ...
    static final class Begin extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int fromIndex = (matcher4Search.anchoringBounds) ? matcher4Search.from : 0;
            if (i == fromIndex && next.match(matcher4Search, i, seq, true)) {
                matcher4Search.first = i;
                matcher4Search.groups[0] = i;
                matcher4Search.groups[1] = matcher4Search.last;
                return true;
            } else {
                return false;
    ...
    static final class End extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int endIndex = (matcher4Search.anchoringBounds) ? matcher4Search.to : matcher4Search.getTextLength();
            if (i == endIndex) {
                matcher4Search.hitEnd = true;
                return next.match(matcher4Search, i, seq, true);
            }
            return false;
        }
    }
    ...
    static final class Caret extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int startIndex = matcher4Search.from;
            int endIndex = matcher4Search.to;
            if (!matcher4Search.anchoringBounds) {
                startIndex = 0;
                endIndex = matcher4Search.getTextLength();
            }
    ...
    static final class Dollar extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            matcher4Search.requireEnd = true;
            return next.match(matcher4Search, i, seq, true);
        }
    ...
    static final class LineEnding extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            if (i < matcher4Search.to) {
                int ch = seq.charAt(i);
                if (ch == 0x0A || ch == 0x0B || ch == 0x0C || ch == 0x85 || ch == 0x2028 || ch == 0x2029)
                    return next.match(matcher4Search, i + 1, seq, true);
                if (ch == 0x0D) {
                    i++;
                    if (i < matcher4Search.to && seq.charAt(i) == 0x0A)
                        i++;
                    return next.match(matcher4Search, i, seq, true);
                }
            } else {
    ...
    private static abstract class CharProperty extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            if (i < matcher4Search.to) {
                ...
                return isSatisfiedBy(ch) && next.match(matcher4Search, i + Character.charCount(ch), seq, true);
            } else {
                matcher4Search.hitEnd = true;
                return false;
            }
    ...
    private static abstract class BmpCharProperty extends CharProperty {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            if (i < matcher4Search.to) {
                return isSatisfiedBy(seq.charAt(i)) && next.match(matcher4Search, i + 1, seq, true);
            } else {
                matcher4Search.hitEnd = true;
                return false;
            }
    ...
    static final class Slice extends SliceNode {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            return next.match(matcher4Search, i + len, seq, true);
        }
    }
    ...
    static final class SliceS extends SliceNode {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            return next.match(matcher4Search, x, seq, true);
        }
    }
    ...
    static final class Ques extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            switch (type) {
                case GREEDY:
                    return (atom.match(matcher4Search, i, seq, true) && next.match(matcher4Search, matcher4Search.last, seq, true))
                            || next.match(matcher4Search, i, seq, true);
                case LAZY:
                    return next.match(matcher4Search, i, seq, true)
                            || (atom.match(matcher4Search, i, seq, true) && next.match(matcher4Search, matcher4Search.last, seq, true));
                case POSSESSIVE:
                    if (atom.match(matcher4Search, i, seq, true))
                        i = matcher4Search.last;
                    return next.match(matcher4Search, i, seq, true);
                default:
                    return atom.match(matcher4Search, i, seq, true) && next.match(matcher4Search, matcher4Search.last, seq, true);
            }
    ...
    static final class Curly extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            if (type == GREEDY)
                return match0(matcher4Search, i, j, seq);
            else if (type == LAZY)
                return match1(matcher4Search, i, j, seq);
            else
                return match2(matcher4Search, i, j, seq);
        }

        // Greedy match.
        // i is the index to start matching at
        // j is the number of atoms that have matched
        boolean match0(Matcher4Search matcher4Search, int i, int j, CharSequence seq) {
            if (j >= cmax) {
            ...
            int backLimit = j;
            while (atom.match(matcher4Search, i, seq, true)) {
                // k is the length of this match
                int k = matcher4Search.last - i;
                ...
                while (j < cmax) {
                    if (!atom.match(matcher4Search, i, seq, true))
                        break;
                    if (i + k != matcher4Search.last) {
                        if (match0(matcher4Search, matcher4Search.last, j + 1, seq))
                            return true;
                        break;
                    }
                    i += k;
        ...
        // i is the index to start matching at
        // j is the number of atoms that have matched
        boolean match1(Matcher4Search matcher4Search, int i, int j, CharSequence seq) {
            for (;;) {
        ...
        boolean match2(Matcher4Search matcher4Search, int i, int j, CharSequence seq) {
            for (; j < cmax; j++) {
                if (!atom.match(matcher4Search, i, seq, true))
                    break;
                if (i == matcher4Search.last)
    ...
    static final class GroupCurly extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            int[] groups = matcher4Search.groups;
            int[] locals = matcher4Search.locals;
            ...
            for (int j = 0; j < cmin; j++) {
                if (atom.match(matcher4Search, i, seq, true)) {
                    if (capture) {
                        groups[groupIndex] = i;
                        groups[groupIndex + 1] = matcher4Search.last;
                    }
                    i = matcher4Search.last;
                } else {
                    ret = false;
            ...
            if (ret) {
                if (type == GREEDY) {
                    ret = match0(matcher4Search, i, cmin, seq);
                } else if (type == LAZY) {
                    ret = match1(matcher4Search, i, cmin, seq);
                } else {
                    ret = match2(matcher4Search, i, cmin, seq);
                }
            }
            if (!ret) {
            ...
            for (;;) {
                ...
                for (;;) {
                    ...
                    if (!atom.match(matcher4Search, i, seq, true))
                        break;
                    if (i + k != matcher4Search.last) {
                        if (match0(matcher4Search, i, j, seq))
                            return true;
                        break;
                    }
                }
        ...
        boolean match1(Matcher4Search matcher4Search, int i, int j, CharSequence seq) {
            for (;;) {
                ...
                if (i == matcher4Search.last)
                    return false;
                if (capture) {
                    matcher4Search.groups[groupIndex] = i;
                    matcher4Search.groups[groupIndex + 1] = matcher4Search.last;
                }
                i = matcher4Search.last;
                j++;
            }
    ...
    static final class Branch extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            for (int n = 0; n < size; n++) {
                if (atoms[n] == null) {
                    if (conn.next.match(matcher4Search, i, seq, true))
                        return true;
                } else if (atoms[n].match(matcher4Search, i, seq, true)) {
                    return true;
                }
            }
            return false;
    ...
    static final class GroupHead extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int save = matcher4Search.locals[localIndex];
            matcher4Search.locals[localIndex] = i;
            boolean ret = next.match(matcher4Search, i, seq, true);
            matcher4Search.locals[localIndex] = save;
            return ret;
        }

        boolean matchRef(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int save = matcher4Search.locals[localIndex];
            matcher4Search.locals[localIndex] = ~i; // HACK
            boolean ret = next.match(matcher4Search, i, seq, true);
            matcher4Search.locals[localIndex] = save;
            return ret;
        }
    ...
    static final class GroupRef extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            return head.matchRef(matcher4Search, i, seq) && next.match(matcher4Search, matcher4Search.last, seq, true);
        }
    ...
    static final class GroupTail extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int tmp = matcher4Search.locals[localIndex];
            if (tmp >= 0) { // This is the normal group case.
                // Save the group so we can unset it if it
                // backs off of a match.
                int groupStart = matcher4Search.groups[groupIndex];
                int groupEnd = matcher4Search.groups[groupIndex + 1];

                matcher4Search.groups[groupIndex] = tmp;
                matcher4Search.groups[groupIndex + 1] = i;
                if (next.match(matcher4Search, i, seq, true)) {
                    return true;
                }
                matcher4Search.groups[groupIndex] = groupStart;
                matcher4Search.groups[groupIndex + 1] = groupEnd;
                return false;
            } else {
    ...
    static final class Prolog extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            return loop.matchInit(matcher4Search, i, seq, true);
        }
    ...
    static class Loop extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            if (i > matcher4Search.locals[beginIndex]) {
                int count = matcher4Search.locals[countIndex];

                // This block is for before we reach the minimum
                // iterations required for the loop to match
                if (count < cmin) {
                    matcher4Search.locals[countIndex] = count + 1;
                    boolean b = body.match(matcher4Search, i, seq, true);
                    // If match failed we must backtrack, so
                    // the loop count should NOT be incremented
                    if (!b)
                        matcher4Search.locals[countIndex] = count;
        ...
        boolean matchInit(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int save = matcher4Search.locals[countIndex];
            boolean ret = false;
            if (0 < cmin) {
                matcher4Search.locals[countIndex] = 1;
                ret = body.match(matcher4Search, i, seq, true);
            } else if (0 < cmax) {
                matcher4Search.locals[countIndex] = 1;
                ret = body.match(matcher4Search, i, seq, true);
                if (ret == false)
                    ret = next.match(matcher4Search, i, seq, true);
            } else {
                ret = next.match(matcher4Search, i, seq, true);
            }
            matcher4Search.locals[countIndex] = save;
            return ret;
        }
    ...
    static final class LazyLoop extends Loop {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            if (i > matcher4Search.locals[beginIndex]) {
                ...
                if (count < cmin) {
                    matcher4Search.locals[countIndex] = count + 1;
                    boolean result = body.match(matcher4Search, i, seq, true);
                    // If match failed we must backtrack, so
                    // the loop count should NOT be incremented
                    if (!result)
                        matcher4Search.locals[countIndex] = count;
        ...
        boolean matchInit(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            if (0 < cmin) {
                matcher4Search.locals[countIndex] = 1;
                ret = body.match(matcher4Search, i, seq, true);
            } else if (next.match(matcher4Search, i, seq, true)) {
                ret = true;
            } else if (0 < cmax) {
                matcher4Search.locals[countIndex] = 1;
                ret = body.match(matcher4Search, i, seq, true);
    ...
    static class BackRef extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int j = matcher4Search.groups[groupIndex];
            int k = matcher4Search.groups[groupIndex + 1];
            ...
            if (i + groupSize > matcher4Search.to) {
                matcher4Search.hitEnd = true;
                return false;
            }
            ...
            return next.match(matcher4Search, i + groupSize, seq, true);
        }
    ...
    static final class First extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            ...
            for (;;) {
                ...
                if (atom.match(matcher4Search, i, seq, true)) {
                    return next.match(matcher4Search, matcher4Search.last, seq, true);
                }
                i += countChars(seq, i, 1);
                matcher4Search.first++;
            }
        }
    ...
    static final class Conditional extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            if (cond.match(matcher4Search, i, seq, true)) {
                return yes.match(matcher4Search, i, seq, true);
            } else {
                return not.match(matcher4Search, i, seq, true);
            }
        }
    ...
    static final class Pos extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int savedTo = matcher4Search.to;
            boolean conditionMatched = false;

            // Relax transparent region boundaries for lookahead
            if (matcher4Search.transparentBounds)
                matcher4Search.to = matcher4Search.getTextLength();
            try {
                conditionMatched = cond.match(matcher4Search, i, seq, true);
            } finally {
                // Reinstate region boundaries
                matcher4Search.to = savedTo;
            }
            return conditionMatched && next.match(matcher4Search, i, seq, true);
        }
    }
    ...
    static Node lookbehindEnd = new Node("") {
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            return i == matcher4Search.lookbehindTo;
        }
    };
    ...
    static class Behind extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int savedFrom = matcher4Search.from;
            boolean conditionMatched = false;
            int startIndex = (!matcher4Search.transparentBounds) ? matcher4Search.from : 0;
            int from = Math.max(i - rmax, startIndex);
            // Set end boundary
            int savedLBT = matcher4Search.lookbehindTo;
            matcher4Search.lookbehindTo = i;
            // Relax transparent region boundaries for lookbehind
            if (matcher4Search.transparentBounds)
                matcher4Search.from = 0;
            for (int j = i - rmin; !conditionMatched && j >= from; j--) {
                conditionMatched = cond.match(matcher4Search, j, seq, true);
            }
            matcher4Search.from = savedFrom;
            matcher4Search.lookbehindTo = savedLBT;
            return conditionMatched && next.match(matcher4Search, i, seq, true);
        }
    }
    ...
    static final class Bound extends Node {
        ...
        int check(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int ch;
            boolean left = false;
            int startIndex = matcher4Search.from;
            int endIndex = matcher4Search.to;
            ...
            if (i > startIndex) {
                ...
                left = (isWord(ch) || ((Character.getType(ch) == Character.NON_SPACING_MARK)
                        && hasBaseCharacter(matcher4Search, i - 1, seq)));
            }
            boolean right = false;
            if (i < endIndex) {
                ch = Character.codePointAt(seq, i);
                right = (isWord(ch) || ((Character.getType(ch) == Character.NON_SPACING_MARK)
                        && hasBaseCharacter(matcher4Search, i, seq)));
            } else {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            return (check(matcher4Search, i, seq) & type) > 0 && next.match(matcher4Search, i, seq, true);
        }
    }
     ...
     */
    private static boolean hasBaseCharacter(Matcher4Search matcher4Search, int i, CharSequence seq) {
        int start = (!matcher4Search.transparentBounds) ? matcher4Search.from : 0;
    ...
    static class BnM extends Node {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int[] src = buffer;
            int patternLength = src.length;
            int last = matcher4Search.to - patternLength;
            ...
            NEXT: while (i <= last) {
                ...
                matcher4Search.first = i;
                boolean ret = next.match(matcher4Search, i + patternLength, seq, true);
                if (ret) {
                    matcher4Search.first = i;
                    matcher4Search.groups[0] = matcher4Search.first;
                    matcher4Search.groups[1] = matcher4Search.last;
    ...
    static final class BnMS extends BnM {
        ...
        boolean match(Matcher4Search matcher4Search, int i, CharSequence seq) {
            int[] src = buffer;
            int patternLength = src.length;
            int last = matcher4Search.to - lengthInChars;
            ...
            NEXT: while (i <= last) {
                ...
                // Entire pattern matched starting at i
                matcher4Search.first = i;
                boolean ret = next.match(matcher4Search, i + lengthInChars, seq, true);
                if (ret) {
                    matcher4Search.first = i;
                    matcher4Search.groups[0] = matcher4Search.first;
                    matcher4Search.groups[1] = matcher4Search.last;
